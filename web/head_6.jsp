                ...
                <nav class="side-navbar z-index-40">
                    ...
                    <div class="sidebar-header d-flex align-items-center py-4 px-3"><img class="avatar shadow-0 img-fluid rounded-circle" src="img/Logo (2).png" alt="...">
                        <div class="ms-3 title">
                            <h1 class="h4 mb-2">PLAN DE PRESTANCIONES</h1>
                    ...
                    <ul class="list-unstyled py-4">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="FACTURA.jsp"> 
                                <img src="img/receipt-cutoff.svg" class="svg-icon svg-icon-sm svg-icon-heavy me-xl-4">
                                Facturas </a></li>
                                
                        <li class="sidebar-item"> <a class="sidebar-link" <a href="manuales/ManualUsuarioPlan.pdf">
                                <img src="img/journal-richtext.svg" class="svg-icon svg-icon-sm svg-icon-heavy me-xl-4">
                                Manual </a></li>
