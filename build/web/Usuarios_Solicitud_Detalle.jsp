                ...
                <table id="example" border="1"   class="display table table-hover table-bordered table-striped" style="width:100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th><a href="download?usuario_servicio=<%= sol.getUPIS_ID_USUARIO_SERVICIO()%>&DPI=<%= sol.getUPIS_DPI()%>&CAT=<%= user1.getCATEGORIA()%>&TIPO=FILE_DPI">Ver Archivo</a></th>
                            <th><a href="download?usuario_servicio=<%= sol.getUPIS_ID_USUARIO_SERVICIO()%>&DPI=<%= sol.getUPIS_DPI()%>&CAT=<%= user1.getCATEGORIA()%>&TIPO=FILE_CARNET">Ver Archivo</a></th>
                            <th><a href="download?usuario_servicio=<%= sol.getUPIS_ID_USUARIO_SERVICIO()%>&DPI=<%= sol.getUPIS_DPI()%>&CAT=<%= user1.getCATEGORIA()%>&TIPO=FILE_LEGAL">Ver Archivo</a></th>
