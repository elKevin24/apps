...
<%@page import="controlador.BeanComentario"%>
...
<html>
    ...
    <body>
        <table id="table_id" border="1"   class="table table-striped table-hover ">
            <thead>
                <tr >
                    <th colspan="4"class="bg-info text-center">PROCESOS REALIZADAS A ESTE DOCUMENTO</th>
                </tr>
                <tr>
                    <th>CORL</th>
                    <th>PROCESO</th>
            ...
            <tbody>
                <%
                    ...
                    LinkedList<BeanComentario> lista = Factura.ConsultaProceso(a);

                    for (int i = 0; i < lista.size(); i++) {
                        out.println("<tr>");
                        out.println("<td>" + lista.get(i).getPLPP_CORRELATIVO() + "</td>");
                        out.println("<td>" + lista.get(i).getPLPP_PROCESO() + "</td>");
