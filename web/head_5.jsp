                ...
                <nav class="side-navbar z-index-40">
                    ...
                    <ul class="list-unstyled py-4">
                        ...
                        <!--                        <li class="sidebar-item"><a class="sidebar-link" href="#exampledropdownDropdown" data-bs-toggle="collapse"> 
                                                        ...
                                                        </svg>Carta Porte </a></li>
                                                <ul class="collapse list-unstyled " id="exampledropdownDropdown">
                                                    
                        
                        
                                                    <li><a class="sidebar-link" href="carta_porte.jsp">Crear Documento</a></li>
                                                    <li><a class="sidebar-link" href="Trazabilidad_Barcos_Export.jsp">Carga</a></li>
                                                </ul>-->



                        <li class="sidebar-item"> <a class="sidebar-link" href="carta_porte.jsp"> 
                                <i class="far fa-clipboard"></i>
                                <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-0">
                                <!--<use xlink:href="#chart-1"> </use>-->
                                </svg>Crear Documento </a></li>


                        <li class="sidebar-item"><a class="sidebar-link" href="#Inventario_Conte_Contenedores" data-bs-toggle="collapse"> 
                                <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-0">
                                <use xlink:href="#portfolio-grid-1"> </use>
                                </svg>Documentos Creados </a></li>
                        <ul class="collapse list-unstyled " id="Inventario_Conte_Contenedores">
                            <li><a class="sidebar-link" href="Consulta.jsp">Consulta</a></li>
                            <li><a class="sidebar-link" href="EstadoCarta.jsp">Estado</a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="pilotos.jsp"> 
                                <i class="bi bi-person-circle"></i>
                                <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-0">
                                <!--<use xlink:href="#chart-1"> </use>-->
                                
                                </svg>Crear Piloto </a></li>
